  ...
  <div class="app-content pt-3 p-md-3 p-lg-4">
    <div class="container-xl">
      <div class="col-auto pt-3">
        <h1 class="app-page-title">Registo de Protocolo</h1>
      </div>
      <form
        novalidate
        @submit.prevent="createProtocol()"
        >
              ...
              <div class="mb-3 row">
                <div class="col-12 col-md-12">
                  <div class="app-card app-card-settings shadow-sm p-4">
                    ...
                    <button type="submit" class="btn app-btn-primary col-12 col-md-12" >Adicionar Protocolo</button>
                  </div>
                </div>
              </div>
            </div>
...
export default {
  ...
  methods: {
    ...
    async createProtocol() {
      try {
        // console.log('pdf_path_envio:', this.pdf_path);
        ...
        const response = await axios.post(`${baseURL}/protocol-internal-externals`, formData, config);
        if (response.status === 201) {
          this.showAlert('Protocolo criado com sucesso', 'success');
          const self = this;
          setTimeout(function() {
        ...
        if (error.response){
          if (error.response.status === 422){
            ...
            this.showAlert('Erro ao criar o Protocolo', 'error');
          }
    ...
    handleFileUpload() {
      // this.pdf_path = event.target.files[0];
      // console.log('pdf_path:', this.pdf_path);
